...
async function fetchCsv() {
  const url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSvMVqjLXOLoY5Jt1u8gmOBD_2IZit7yqKN8N94ubeOvyx94qyLCdLp19kAkp594OJzEfna5RO_Fcjv/pub?gid=118444411&single=true&output=csv'
...
function normalizeSourceName(sourceName, dedupes) {
  const match = dedupes.find(d => d.sourceName.toLowerCase() === sourceName.trim().toLowerCase())
